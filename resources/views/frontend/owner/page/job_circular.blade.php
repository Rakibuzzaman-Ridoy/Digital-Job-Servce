     ...
     <form action="{{route('store.jobcircular')}}" method="post">
      @csrf
        <div class="form-group">
         ...
         <input type="text" class="form-control"name="name"  id=" name" placeholder="Job position"required>
        </div>
        <div class="form-group">
         <label for="exampleInputEmail1">No. of Vacancies</label>
         <input type="number" class="form-control"name="vacancies"  id=" name" placeholder="No. of Vacancies"required>
        </div>
        <div class="form-group">
       ...
       <div class="form-group">
         ...
         <textarea class="form-control"  id="comment" name="education"required ></textarea>
        </div>
        <div class="form-group">
         <label for="exampleInputEmail1">Experience Requirements</label>
         <input type="tex" class="form-control"name="experience"  id=" name" placeholder="Experience Requirements"required>
        </div>
        <div class="form-group">
         <label for="exampleInputEmail1">Additional Job Requirements</label>
         <textarea class="form-control"  id="comment" name="additional"required ></textarea>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
         ...
         <input type="text" class="form-control"name="salary"  id=" name" placeholder="Salary Range"required>
        </div>
        <div class="form-group">
            <label for="exampleInputEmail1">Deadline</label>
            <input type="datetime-local" class="form-control"name="dateline"  id=" name" placeholder="Dateline"required>
        </div>
